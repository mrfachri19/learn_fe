          ...
          <div className="w-full text-gray-700">
            <div className="flex flex-col md:items-center md:justify-between md:flex-row">
              <div className="flex flex-row items-center justify-between p-4">
                <button className="rounded-lg md:hidden focus:outline-none text-white cursor-pointer focus:shadow-outline"
              ...
              <nav className={`pb-4 md:pb-0 md:flex md:justify-end md:flex-row mx-5 ${show == true ? "" : "hidden"}`}>
                <a
