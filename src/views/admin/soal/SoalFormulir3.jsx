        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Berikut ini adalah penulisan tag label yang benar, kecuali?
            </div>
...
`}{" "}
                  ...
                  <Radio value={2}>
                    b.{" "}
                    {`<label for=”nama”>Nama:
<input type=”text” id=”nama” name=”nama”> </label> 
`}
                  </Radio>
                  <Radio value={3}>
                    c.{" "}
...
`}{" "}
                  ...
                  <Radio value={4}>
                    d.{" "}
                    {`<input type=”text” id=”nama” name=”nama”> << <label for=”nama”>Nama </label>`}
                  </Radio>
                </Space>
              </Radio.Group>
            </div>
