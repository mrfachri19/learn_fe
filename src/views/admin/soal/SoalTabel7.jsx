        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Atribut yang berguna untuk menyatukan sel (baris) ke samping?
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}>a.	cellspacing </Radio>
                  <Radio value={2}>b. rowspan   </Radio>
                  <Radio value={3}>c. cellspacing </Radio>
                  <Radio value={4}>d. collspan </Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
