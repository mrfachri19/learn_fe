        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Atribut manakah yang wajib ada pada input type radio dan checkbox?{" "}
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}> a. {"Atribut “class” "} </Radio>
                  <Radio value={2}>b. {"Atribut “name” "}</Radio>
                  <Radio value={3}>c. {"Atribut “style"} </Radio>
                  <Radio value={4}>d. {"Atribut “id”"}</Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
