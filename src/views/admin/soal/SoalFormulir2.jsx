      ...
      <div className="flex items-center justify-center mt-5 mb-10">
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            ...
            Input type apa yang berguna untuk memproses formulir (tag form)?            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}> a. {"Input type “submit”  "} </Radio>
                  <Radio value={2}>b. {"Input type “password”  "}</Radio>
                  <Radio value={3}>c. {"Input type “radio” "} </Radio>
                  <Radio value={4}>d. {"Input type “process” "}</Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
