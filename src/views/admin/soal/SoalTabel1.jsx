        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Tag yang berguna untuk mendefinisikan baris pada tabel?{" "}
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}> a. {"<column></column>"} </Radio>
                  <Radio value={2}>b. {"<tr></tr> "}</Radio>
                  <Radio value={3}>c. {"<td></td>"} </Radio>
                  <Radio value={4}>d. {"<table></table>"}</Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
