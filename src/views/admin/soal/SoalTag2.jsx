        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Tag untuk mendefinisikan sebuah pilihan dalam bentuk dropdown?{" "}
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}> a. {"<span></span>"} </Radio>
                  <Radio value={2}>b. {"<summary></summary>"} </Radio>
                  <Radio value={3}>c. {"<option></option> "} </Radio>
                  <Radio value={4}>d. {"<meta>"} </Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
