      ...
      <div className="flex items-center justify-center mt-5 mb-10">
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            ...
            Pada umumnya CSS dipakai untuk memformat tampilan halaman website yang dibuat dengan ...            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}>Html dan XHtml </Radio>
                  <Radio value={2}>Xhtml dan Xml </Radio>
                  <Radio value={3}>Xml dan PHP </Radio>
                  <Radio value={4}>XHTML dan JS </Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
