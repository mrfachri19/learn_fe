      ...
      <div className="flex items-center justify-center mt-5 mb-10">
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            ...
            Berikut ini macam dari font-size pada CSS, kecuali :            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}>{"xxx-large"} </Radio>
                  <Radio value={2}>xx-small </Radio>
                  <Radio value={3}>small</Radio>
