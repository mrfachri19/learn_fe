...
import berhasil from "../../../assets/images/badgeLearn-Perkenalan (1).png"
...
function Soalcss5() {
  ...
  const getId = async () => {
    try {
      ...
      setgambar(response.data.data[0].point);
      ...
      <div className="flex items-center justify-center mt-5 mb-10">
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            ...
            Bagian pada CSS yang terletak sebelum {'{}'} disebut
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}>Propertyl </Radio>
                  <Radio value={2}>Declaration </Radio>
                  <Radio value={3}>Selector </Radio>
                  <Radio value={4}>Value</Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
