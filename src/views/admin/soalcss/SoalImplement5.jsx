...
import berhasil from "../../../assets/images/badgeLearn-IntegrasiCSSHTML.png"

function SoalImplement5() {
        ...
        <div className="rounded-xl border p-5 shadow-md w-1/2 bg-white">
          ...
          <div className="mt-4 mb-6">
            <div className="text-sm text-gray-900 mb-3">
              Pilih selector CSS yang tidak valid:{" "}
            </div>
            <div className="text-sm text-gray-900 mt-10 mb-20 w-full">
              <Radio.Group onChange={onChange} value={value}>
                <Space direction="vertical">
                  <Radio value={1}>{"."} </Radio>
                  <Radio value={2}>html {">"} body </Radio>
                  <Radio value={3}>div {"<"} p</Radio>
                  <Radio value={4}>{`a[href=”https://learniverse.id”]`} </Radio>
                </Space>
              </Radio.Group>
            </div>
            <div
